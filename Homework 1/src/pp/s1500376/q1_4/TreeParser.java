...
public class TreeParser extends Parser {
	...
	public static class LeftContext extends NodeContext {
		...
		public LeftContext(NodeContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof TreeListener ) ((TreeListener)listener).enterLeft(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof TreeListener ) ((TreeListener)listener).exitLeft(this);
		}
	}
	public static class NumContext extends NodeContext {
		public TerminalNode NUM() { return getToken(TreeParser.NUM, 0); }
		public NumContext(NodeContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof TreeListener ) ((TreeListener)listener).enterNum(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof TreeListener ) ((TreeListener)listener).exitNum(this);
		}
	}
	public static class RightContext extends NodeContext {
		public TerminalNode LPAR() { return getToken(TreeParser.LPAR, 0); }
		public TerminalNode NUM() { return getToken(TreeParser.NUM, 0); }
		...
		public TerminalNode RPAR() { return getToken(TreeParser.RPAR, 0); }
		public RightContext(NodeContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof TreeListener ) ((TreeListener)listener).enterRight(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof TreeListener ) ((TreeListener)listener).exitRight(this);
		}
	}
	public static class FullContext extends NodeContext {
		public TerminalNode LPAR() { return getToken(TreeParser.LPAR, 0); }
		...
		public TerminalNode RIGHT() { return getToken(TreeParser.RIGHT, 0); }
		public TerminalNode RPAR() { return getToken(TreeParser.RPAR, 0); }
		public FullContext(NodeContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof TreeListener ) ((TreeListener)listener).enterFull(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof TreeListener ) ((TreeListener)listener).exitFull(this);
		}
	}
